...
class MultitaskBERT(nn.Module):
    ...
    def predict_paraphrase(self,
        ...
        ### TODO
        #raise NotImplementedError
        # Get the BERT embeddings for the first and second sentences
        ...
        logit = self.paraphrase_classifier(embeddings)
        return logit
    ...
    def predict_similarity(self,
        ...
        # Concatenate the embeddings
        embeddings = torch.cat((embeddings_1, embeddings_2), dim=1)
        # Pass the concatenated embeddings through the similarity regressor
        logit = self.similarity_regressor(embeddings)
        return logit
